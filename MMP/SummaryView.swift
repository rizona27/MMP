                                        ...
                                        if let funds = allGroupedFunds[fundCode], let firstFund = funds.first {
                                            VStack(spacing: 0) {
                                                ...
                                                Button(action: {
                                                    ...
                                                    HStack(alignment: .center) {
                                                        HStack(spacing: 8) {
                                                            ...
                                                            .background(
                                                                LinearGradient(
                                                                    gradient: Gradient(colors: [firstFund.fundCode.morandiColor().opacity(0.8), Color.clear]),
                                                                    startPoint: .leading,
                                                                    endPoint: .trailing
                                                                )
                                                            )
                                                ...
                                                if expandedFundCodes.contains(fundCode) {
                                                    ...
                                                    .padding(.horizontal, 16)
                                                    .padding(.vertical, 12)
                                                    .background(Color(uiColor: .secondarySystemGroupedBackground)) // 修改为与HoldingRow一致的背景色
                                                    .cornerRadius(10)
